...
<form action="update_query.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="number" name="budget" value="<?php  echo $projet["budget"]; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Description</label>
        <div class="col-sm-8">
            <textarea name="description" class="form-control"><?php echo $projet["description"]; ?></textarea>
        </div>
    </div>
    <div class="form-group row">
